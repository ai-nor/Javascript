...
else if (convertkm.length ==1 && lastm == 1) {
    endkm = "";
}
else if ((convertkm.length ===1) && (lastm == 2 || lastm == 3 || lastm == 4 )) {
    endkm = "и";
}
else if ((convertkm.length ===1) && (lastm == 5 || lastm == 6 || lastm == 7 || lastm == 8 || lastm == 9)) {
    endkm = "ів";
}
else if (convertkm.length ===2 && convertm[convertm.length-2] == 1) {
    endkm = "ів";
}
else if (convertkm.length >=2 && lastm == 1) {
    endkm = "";
}
else if ((convertkm.length >=2) && (lastm == 2 || lastm == 3 || lastm == 4 )) {
    endkm = "и";
}
else if ((convertkm.length >=2) && (lastm == 5 || lastm == 6 || lastm == 7 || lastm == 8 || lastm == 9)) {
    endkm = "ів";
}
else {
    console.log ("Щось не врахувала");
